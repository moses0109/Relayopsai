            ...
            <div className="bg-[#0a0a0f]/95 backdrop-blur-3xl rounded-33 border border-blue-500/20 shadow-2xl shadow-blue-500/10 p-4 call-slide-in">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3 flex-shrink-0">
                  ...
                  <button onClick={acceptCall} className="w-10 h-10 rounded-full bg-blue-600 hover:bg-blue-500 flex items-center justify-center active:scale-90 transition-all shadow-lg shadow-blue-500/30 accept-pulse">
          ...
          {isCallActive && (
            <div className="bg-[#0a192f]/90 backdrop-blur-2xl rounded-2xl border border-blue-500/30 shadow-2xl shadow-blue-500/20 p-4">
              <div className="flex items-center gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-blue-400 text-[10px] font-black uppercase tracking-widest">Live Integration — Relay AI</p>
                  <div className="flex items-center gap-[3px] h-5 mt-1">
                    {Array.from({ length: 24 }).map((_, i) => (
                      <div key={i} className="w-[3px] bg-blue-400 rounded-full" style={{
                        height: '14px',
                ...
                <button onClick={endCall} className="flex-shrink-0 w-10 h-10 rounded-full bg-rose-500 hover:bg-rose-600 flex items-center justify-center active:scale-90 transition-all">
                  <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 9c-1.6 0-3.15.25-4.6.72v3.1c0 .39-.23.74-.56.9-.98.49-1.87 1.12-2.66 1.85-.18.18-.43.28-.7.28-.28 0-.53-.11-.71-.29L.29 13.08c-.18-.17-.29-.42-.29-.7 0-.28.11-.53.29-.71C3.34 8.78 7.46 7 12 7s8.66 1.78 11.71 4.67c.18.18.29.43.29.71 0 .28-.11.53-.29.71l-2.48 2.48c-.18.18-.43.29-.71.29-.27 0-.52-.11-.7-.28-.79-.74-1.69-1.36-2.67-1.85-.33-.16-.56-.5-.56-.9v-3.1C15.15 9.25 13.6 9 12 9z" />
                  </svg>
                </button>
